...
export default function PengeluaranPage() {
    ...
    const fetchTransactions = async () => {
        setIsLoading(true);
        try {
            const response = await fetch("/dashboard/api/keuangan/transaksi?tipe=pengeluaran");
                ...
                <div className="mb-6 flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                            Kelola transaksi pengeluaran organisasi
                        </p>
                    </div>
                    <button
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="Contoh: Snack Pertemuan"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Deskripsi detail tentang pengeluaran ini..."
                                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-red-500 focus:border-transparent"
                                    rows={3}
                                    required
                                />
                            ...
                            <div className="flex gap-3">
                                <button
                                    ...
                                    className="flex-1 bg-red-600 text-white py-3 rounded-md font-semibold hover:bg-red-700 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
                                >
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                    ...
                    {isLoading ? (
                        <div className="flex justify-center items-center py-12">
                            <div className="w-10 h-10 border-t-2 border-red-600 rounded-full animate-spin"></div>
                        </div>
