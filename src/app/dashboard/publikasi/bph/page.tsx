...
export default function Page() {
  return (
    ...
    //           Halaman ini berisi informasi mengenai publikasi Badan Pengurus
    //           Harian (BPH). kamu dapat melihat detail
    //           publikasi BPH serta mengedit informasi tersebut sesuai kebutuhan.
    //         </p>
    //       </div>

    //       <div className="flex w-full lg:justify-end lg:pr-6 mt-8">
    //         <Link
    //         href={"/dashboard/publikasi/bph/edit"}
    ...
    //           <Image
    //             src="/assets/static-img/publikasi_guide_bph.png"
    //             width={1000}
    //             height={1000}
    //             alt="logo"
